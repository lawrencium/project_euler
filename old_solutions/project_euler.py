        ...
        for scrambled_multiplicand in scrambled_multiplicands:
            ...
            for multiplier in multipliers:
                ...
                for scrambled_multiplier in scrambled_multipliers:
                    ...
                    if len(all_digits) == len(set(all_digits)) and not '0' in str(product) and len(all_digits) == len(
                            PANDIGITAL_DIGITS):
...
def p52():
    ...
    while True:
        for i in xrange(range_start, 2 * range_start):
            if same_ints(i, 2 * i) and same_ints(i, 3 * i) and same_ints(i, 4 * i) and same_ints(i,
                                                                                                 5 * i) and same_ints(i,
                                                                                                                      6 * i):
...
def p54():
    ...
    def determine_hand(hand):
        ...
        hand_values = map(lambda x: x if not (x in {"T": "10", "J": "11", "Q": "12", "K": "13", "A": "14"}) else
        {"T": "10", "J": "11", "Q": "12", "K": "13", "A": "14"}[x], hand_values)
    ...
    def tiebreak(hand1, hand2, v):
        ...
        hand1_vs = map(lambda x: x if not (x in {"T": "10", "J": "11", "Q": "12", "K": "13", "A": "14"}) else
        {"T": "10", "J": "11", "Q": "12", "K": "13", "A": "14"}[x], hand1_vs)
        ...
        hand2_vs = map(lambda x: x if not (x in {"T": "10", "J": "11", "Q": "12", "K": "13", "A": "14"}) else
        {"T": "10", "J": "11", "Q": "12", "K": "13", "A": "14"}[x], hand2_vs)
...
def p84():
    ...
    class Monopoly(object):
        ...
        def initialize_community_chest(self):
            ...
            self.community_chest_deck = [lambda x: x for i in
                                         range(14)]  # initialize 14 cards that don't affect movement
